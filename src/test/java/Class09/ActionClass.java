...
//        action.dragAndDrop(draggable,dropLocation).perform();
        ...
        //OR(alternative way of chaining multiple methods)
        //Whenerver we are chaining more than 1 method in action class,we have to use .build()
         // at the end and then call .perform();
